    ...
    <div className="relative min-h-screen">
      <header className="sticky top-0 z-30 border-b border-white/10 bg-black/30 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <nav className="hidden gap-4 text-sm text-white/70 md:flex">
            ...
            <Link className="hover:text-white" href="/card">
              Card
            </Link>
            <Link className="hover:text-white" href="/terminal">
              Terminal
            </Link>
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-30 border-t border-white/10 bg-black/35 backdrop-blur-xl md:hidden">
        <div className="mx-auto grid max-w-6xl grid-cols-5 px-2 py-2 text-xs text-white/60">
          <Link className="px-2 py-2 text-center hover:text-white" href="/">
            Home
          </Link>
          <Link className="px-2 py-2 text-center hover:text-white" href="/register">
            Reg
          </Link>
          <Link className="px-2 py-2 text-center hover:text-white" href="/card">
            Card
          </Link>
          <Link className="px-2 py-2 text-center hover:text-white" href="/terminal">
            Tap
          </Link>
          <Link className="px-2 py-2 text-center hover:text-white" href="/admin">
            Admin
          </Link>
        </div>
      </footer>
